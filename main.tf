...
module "lambda_module" {
  ...
  app_image_bucket_arn                       = module.s3_module.app_image_bucket_arn
  app_on_object_created_topic_arn            = module.sns_module.app_on_object_created_topic_arn
  delete_face_index_lambda_iam_role_arn      = module.iam_role_module.image_delete_cleanup_lambda_iam_role_arn
  ...
  app_image_bucket_name                      = module.s3_module.app_image_bucket_name
  delete_table_item_lambda_security_group_id = module.security_group_module.delete_table_item_lambda_security_group_id
  image_resize_queue_arn                     = module.sqs_module.image_resize_queue_arn
  image_metadata_queue_arn                   = module.sqs_module.image_metadata_queue_arn
  delete_cleanup_queue_arn                   = module.sqs_module.delete_cleanup_queue_arn
  image_delete_cleanup_lambda_iam_role_arn   = module.iam_role_module.image_delete_cleanup_lambda_iam_role_arn
}
...
module "sqs_module" {
  ...
  face_index_lambda_iam_role_arn           = module.iam_role_module.face_index_lambda_iam_role_arn
  image_delete_cleanup_lambda_iam_role_arn = module.iam_role_module.image_delete_cleanup_lambda_iam_role_arn
  app_sns_on_object_deleted_topic_arn = module.sns_module.app_on_object_deleted_topic_arn
